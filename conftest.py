...
VALID_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ValidOutput")
...
MDEArgs = dict(
    ...
    crossMapCores=5,  # Number of cores for CrossMapColumns
